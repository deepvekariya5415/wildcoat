  ...
  if (materialTabs.length > 0) {
    materialTabs.forEach((tab) => {
      tab.addEventListener("click", () => {
        ...
        document
          .querySelectorAll(".materials-content")
    ...
    sizeCalculatorForm.addEventListener("submit", function (e) {
      ...
      if (gender === "unisex" || gender === "men") {
        if (chest <= 37 && waist <= 30 && hips <= 40) size = "S";
          ...
          note =
            "Your measurements exceed our standard size range. Please contact our customer service for assistance.";
      ...
      document.getElementById("shopButton").style.display = showShopButton
        ? "inline-block"
        : "none";
